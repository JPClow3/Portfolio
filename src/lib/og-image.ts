          ...
          // Top right subtle ambient glow
          {
            ...
            props: {
              style: {
                ...
                width: '500px',
                height: '380px',
                background: 'radial-gradient(circle at 80% 20%, rgba(0, 94, 254, 0.16), transparent 70%)',
              },
            },
          },
          // Bottom left subtle ambient glow
          {
            ...
            props: {
              style: {
                ...
                width: '450px',
                height: '320px',
                background: 'radial-gradient(circle at 20% 80%, rgba(0, 73, 199, 0.16), transparent 70%)',
              },
            },
          },
          // Header Bar
