...
export const ui = {
  en: {
    ...
    'home.approachTitle': 'What I optimize for',
    'home.approachBadge': 'How I work',
    'project.inDevelopment': 'In development',
    'project.caseStudy': 'Case Study',
    'project.breadcrumbHome': 'Home',
    'project.breadcrumbProjects': 'Projects',
    ...
    'contact.social.connect': 'Connect with me',
  ...
  pt: {
    ...
    'contact.error.network': 'Erro de rede ao enviar. Verifique sua conexao e tente novamente.',
    'contact.turnstile.required': 'Conclua a verificacao de seguranca antes de enviar.',
    'contact.turnstile.failed': 'A verificacao de seguranca falhou. Atualize a verificacao e tente novamente.',
    ...
    'contact.social.connect': 'Conecte-se comigo',
